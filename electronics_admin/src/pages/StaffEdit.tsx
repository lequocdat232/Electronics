                    ...
                    <div className="col-span-12">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-[15px]">
                                ...
                                >
                                    <Input disabled className="pl-3 block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" />
                                </Form.Item>
                            </div> 
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-[15px]">
                                <Form.Item
                            ...
                            <div className="my-2">
                                ...
                                <img className="w-[100px] h-[100px] object-cover mb-2" src={
                                    getStaffById.data?.avatar && getStaffById.data?.avatar !== null ? (
