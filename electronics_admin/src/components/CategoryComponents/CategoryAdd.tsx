...
function CategoryAdd() {
  ...
  const postCategory = async (newCategory: ICategory) =>
    axios
      .post(SETTINGS.URL_API + "/v1/Categories", newCategory)
  ...
  return (
    <div className='col-span-12 md:col-span-5'>
      ...
      <Form onSubmitCapture={handleAddCategory}>
        <Form.Item
          name='name'
          rules={[
        ...
        <Radio.Group
          onChange={(e) => setCategoryIsActive(Boolean(e.target.value))}
        >
